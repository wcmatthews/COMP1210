...
public abstract class Pet implements Comparable<Pet>  {
   ...
   */
   public int compareTo(Pet other) {
      ...
      String lastName2 = other.getOwner().substring(other.getOwner().indexOf(" ")+ 1);
      String firstName2 = other.getOwner().substring(0, other.getOwner().indexOf(" "));
      
      return (lastName+firstName).toLowerCase()
                     .compareTo((lastName2+firstName2).toLowerCase());
   }
